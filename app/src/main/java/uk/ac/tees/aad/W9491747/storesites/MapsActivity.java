...
import uk.ac.tees.aad.W9491747.storesites.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationPermissionRequest = registerForActivityResult(new ActivityResultContracts
            ...
            Log.d("Store Sites", "Request sent");
        ...
        locationEntry.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(@NonNull Status status) {
                Log.i("Store Sites", "An error occurred: " + status);
            }
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.i("Store Sites", "Selected location: " + place.getName() + ", " + place.getId());
            }
        });
        ...
        addToFavoritesButton.setOnClickListener(view -> {
            ...
            placesClient.fetchPlace(request).addOnSuccessListener((response) -> {
                ...
                if (status==1) {
                    ...
                    Log.d("Store Sites", "Place already in favorites");
                }
            });
        });
    ...
    public void requestLocationPermissions() {
        ...
        && ContextCompat.checkSelfPermission(this.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            Log.d("Store Sites", "Permissions Needed");
